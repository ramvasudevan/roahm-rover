...
k0_powm2_ind = gen_pow_ind(np.maximum(p[:,w_k[0]]-2,0))
k1_powm2_ind = gen_pow_ind(np.maximum(p[:,w_k[1]]-2,0))
...
fun5 = setup_pow_eval(k0_powm2_ind)
fun6 = setup_pow_eval(k1_powm2_ind)
fun7 = setup_pow_eval(z0_pow_ind)
fun8 = setup_pow_eval(z1_pow_ind)
...
dill.dump(fun5,open('lambda_pow_m2_k0','wb'))
dill.dump(fun6,open('lambda_pow_m2_k1','wb'))
dill.dump(fun7,open('lambda_pow_z0','wb'))
dill.dump(fun8,open('lambda_pow_z1','wb'))
